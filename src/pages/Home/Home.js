...
const Home = () => {
  ...
  return (
    ...
    <img className='image-3' style={{float:'left', animation: 'slide-in-left forwards', animationTimeline: 'view()', animationRange: 'entry 0% cover 40%'}} src={YCimage1}/>
        <div className='content' style={{maxWidth:'50%'}}>
        ...
        <div>
      <img className='image-3' src={YCimage2} style={{animation: 'slide-in-left forwards', animationTimeline: 'view()', animationRange: 'entry 0% cover 40%'}}/>
        ...
        <div>
      <img className='image-3' style={{float:'left', animation: 'slide-in-left forwards', animationTimeline: 'view()', animationRange: 'entry 0% cover 40%'}} src={YCimage3}/>
        ...
        <div>
      <img className='image-3' src={YCimage4} style={{animation: 'slide-in-left forwards', animationTimeline: 'view()', animationRange: 'entry 0% cover 40%'}}/>
